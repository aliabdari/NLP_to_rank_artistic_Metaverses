...
from DNNs import FCNet, LSTMNetwork, ConverterNN
import torch
...
def start_train():
    ...
    model_descriptor = LSTMNetwork(input_size=512, output_size=output_feature_size, bidirectional=is_bidirectional)
    ...
    dataset = DescriptionSceneDatasetV2(data_description_, data_scene_, data_img_, type_model_desc="lstm")
    ...
    if is_bidirectional:
        file_prefix = "bidirectional_lstm_" + type_room
    else:
        file_prefix = "lstm_" + type_room
